...
class TensorIdTracer(contextlib.ContextDecorator):
    ...
    def __call__(self, func):
        ...
        def wrapper(*args, **kwargs):
            ...
            # Print input tensor IDs
            print(f"Operation {self.op_name} input tensors: {format_tensor_ids(input_tensor_ids)}")
            ...
            # Print output tensor IDs
            print(f"Operation {self.op_name} output tensors: {format_tensor_ids(output_tensor_ids)}")
